# Outside Validation Prompt - Phase 31P SIM-R Behavior Transition Wiring Implementation Contract

Validate Codie Phase 31P against `CODIE_V1_CONSTITUTION.md`, the SIM-R roadmap
patch, the accepted Phase 31O behavior-transition wiring contract, and the
accepted Phase 31E/31H/31K/31N SIM-R model implementations.
...
Confirm Phase 31P is implementation-contract-only and creates no implementation
beyond docs and roadmap/status/handoff updates.

Reject if Phase 31P implements:
...
```text
accepted Phase 31O dependency
future wiring implementation files
...
Phase 31Q must not begin until Phase 31P returns PASS or PASS WITH REVIEW
NOTES.

...
the fixed corpus/evaluation contract. Phase 42C is internally complete as the
Rules authority contract. Phase 42D remains blocked until Phase 42C outside

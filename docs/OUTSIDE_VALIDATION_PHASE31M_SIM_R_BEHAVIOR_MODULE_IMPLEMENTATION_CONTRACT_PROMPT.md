# Outside Validation Prompt - Phase 31M SIM-R Behavior Module Implementation Contract

Validate Codie Phase 31M against `CODIE_V1_CONSTITUTION.md`, the SIM-R roadmap
patch, the accepted Phase 31L behavior module contract, and the accepted Phase
...
Confirm Phase 31M is implementation-contract-only and creates no implementation
beyond docs and roadmap/status/handoff updates.

Reject if Phase 31M implements:
...
```text
accepted Phase 31L dependency
future behavior implementation files
...
Phase 31N must not begin until Phase 31M returns PASS or PASS WITH REVIEW
NOTES.

...
class ComboEvidenceSync:
    ...
    def _shared_connection(
        ...
        if curated.connection is not connection or analytics.connection is not connection:
            raise RepositoryError("ComboEvidenceSync repositories must share one SQLite connection")
        return connection
    ...
    def sync_candidates(self, candidates: Iterable[ComboCandidate]) -> ComboSyncResult:
        ...
        with BaseRepository.transaction(self.connection, "combo_evidence_sync"):
